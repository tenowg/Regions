 ...
 * positions that were not set, or if the region existed or not, and the region
 * itself.
 */
public class UpdatedRegion {
	...
	/**
	 * Any positions that were not set when region was attempted to be
	 * created.
	 *
	...
	/**
	 * Did the region exist before it was submitted. This could mean the
	 * name already exists, the UUID was already set (as UUIDs are not set
	 * till creation)
	 *
