...
/**
 * The general API to be used to access Regions from other plugins. Most
 * functions should be available through this API, if for some reason a function
 * is not available, please let a developer know and a solution will likely be
 * added.
 */
public final class RegionAPI {
	...
	/**
	 * Register your feature with Regions, this process will automatically
	 * register any Event listed with Spout to be fired in the
	 * WorldRegionComponent and thus be pasted to the Features attached to
	 * Regions.
	 *
	 ...
	 * @param parser Custom EventParsering being used in registering this
	 * feature.
	 */
	...
	/**
	 * Will search for and return a region by String name and place that
	 * into Players selected region slot.
	 *
	 ...
	 * name is not found.
	 * @throws SelectionCancelledException Thrown when Event fired by select
	 * region is canceled.
	 */
	...
	/**
	 * Will set and return the Points that was set by this method. Will
	 * throw a InvalidPointPositionException Exception if an invalid ENUM or
	 * point was not settable.
	 *
	 * @param player Player attempting to set a Position.
	 * @param enumString The String value of the Position attempting to be
	 * set.
	 * @return The Points that was set.
	 * @throws InvalidPointPositionException Thrown if enumString is not a
	 * valid Position argument.
	 */
	...
	/**
	 * This will attempt to create the region that is in the Players
	 * selected region slot. Will return with PointsNotSetException if all
	 * points of the Volume are not set correctly, and will throw
	 * RegionAlreadyExistsException if the Region had previously been
	 * created (player will need to use updateRegion instead)
	 *
	 * @param player The player attempting to create the region.
	 * @return The region created.
	 * @throws PointsNotSetException Thrown if all points are not set.
	 * @throws RegionAlreadyExistsException Region is not a new Region,
	 * update instead.
	 */
	...
	/**
	 * Sets the VolumeType of the Volume in the players Selected Region
	 * Slot. This will reset the bounds of the Region Volume immediately.
	 *
	 ...
	 * @throws VolumeTypeNotFoundException Thrown when Volume type is not
	 * found.
	 */
